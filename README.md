...
Python 3.12（桌面端/沙盘） · Python 3.7（游戏端，Sims 4 内嵌） · customtkinter GUI · HTTP Server · 文件系统 IPC · Claude / OpenAI / Gemini API
...
独立开发，2026 年持续迭代中。这个项目起源于一个问题："如果 AI 能真正理解游戏世界里发生了什么，它能讲出什么样的故事？"
